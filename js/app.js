...
class RootrixApp {
  ...
  async loadEvents() {
    ...
    grid.innerHTML = `<p style="color:#00ffff;font-family:'Source Code Pro',monospace;text-align:center;width:100%;">Loading events...</p>`;
    ...
    try {
      ...
      if (snapshot.empty) {
        grid.innerHTML = `<p style="color:#888;font-family:'Source Code Pro',monospace;text-align:center;width:100%;">No upcoming events right now. Stay tuned!</p>`;
        return;
      }
      ...
      grid.innerHTML = `<p style="color:#ff0040;font-family:'Source Code Pro',monospace;text-align:center;width:100%;">⚠ Could not load events. Check Firestore rules.</p>`;
    }
  }
  ...
  async loadWriteups() {
    ...
    grid.innerHTML = `<p style="color:#00ffff;font-family:'Source Code Pro',monospace;text-align:center;width:100%;">Loading writeups...</p>`;
    ...
    try {
      ...
      if (snapshot.empty) {
        grid.innerHTML = `<p style="color:#888;font-family:'Source Code Pro',monospace;text-align:center;width:100%;">No writeups yet. Check back soon!</p>`;
        return;
      }
      ...
      grid.innerHTML = `<p style="color:#ff0040;font-family:'Source Code Pro',monospace;text-align:center;width:100%;">⚠ Could not load writeups. Check Firestore rules.</p>`;
    }
  }
  ...
  async loadAchievements() {
    ...
    grid.innerHTML = `<p style="color:#00ffff;font-family:'Source Code Pro',monospace;text-align:center;width:100%;">Loading achievements...</p>`;
    ...
    try {
      ...
      if (snapshot.empty) {
        grid.innerHTML = `<p style="color:#888;font-family:'Source Code Pro',monospace;text-align:center;width:100%;">No achievements yet. Check back soon!</p>`;
        return;
      }

      snapshot.forEach((docSnap) => {
        const achievement = docSnap.data();
        const achievementCard = this.createAchievementCard(achievement, docSnap.id);
        grid.appendChild(achievementCard);
      });
    } catch (error) {
      console.error("Error loading achievements:", error);
      grid.innerHTML = `<p style="color:#ff0040;font-family:'Source Code Pro',monospace;text-align:center;width:100%;">⚠ Could not load achievements. Check Firestore rules.</p>`;
    }
  }
